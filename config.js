...
const baseConfig = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'MONTERO XMD;MONTERO;0;https://i.ibb.co/B598wrtG/raganork-bot.png;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.NOT_ALLOWED || '852',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Montero XMD",
    BOT_NAME: process.env.BOT_NAME || 'Montero XMD',
